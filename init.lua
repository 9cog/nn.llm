...
-- LLM modules (LLaMA architecture)
require('nn.RMSNorm')
require('nn.RotaryEmbedding')
require('nn.SwiGLU')
require('nn.MultiHeadAttention')
require('nn.FeedForward')
require('nn.MLP')
require('nn.TransformerBlock')
require('nn.LLaMA')
require('nn.NeuroSymbolicLLM')
